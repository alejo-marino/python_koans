...
class AboutAttributeAccess(Koan):
    ...
    def test_it_mangles_some_internal_attributes(self):
        ...
        try:
            coconuts = setter.num_of_coconuts   # __setattr__ is called on initialization so num_of_coconuts is no longer a valid attribute
    ...
    def test_in_this_case_private_attributes_remain_unmangled(self):
        ...
        self.assertEqual(2, setter._num_of_private_coconuts)   # this one is unaffected even though __setattr__ is called on initialization due to the leading underscore
