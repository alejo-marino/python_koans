...
class AboutIteration(Koan):
    ...
    def test_iterators_are_a_type(self):
        ...
        self.assertEqual(1 + 2 + 3 + 4 + 5, total)
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Reduce grabas a list of items X, applies an f function to f(x1,x2) and then feeds the output of it to f(x1x2, x3)
    ...
    def test_use_pass_for_iterations_with_no_body(self):
        ...
        self.assertEqual(4, num)    # NOTE: num is still a valid variable even outside the scope of the for loop
