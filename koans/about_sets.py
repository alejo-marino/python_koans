...
class AboutSets(Koan):
    ...
    def test_empty_sets_have_different_syntax_to_populated_sets(self):
        ...
        self.assertEqual(set(), set()) # {} won't work for creating an empty set
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual({'Willie', 'Leonidas'}, scotsmen ^ warriors)   # ^ represents XOR logical operator
    ...
    def test_we_can_compare_subsets(self):
        ...
        self.assertEqual(False, set('cake') > set('pie'))  # {'pie'} is not a strict subset of {'cake'}
