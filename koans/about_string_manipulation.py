...
class AboutStringManipulation(Koan):
    ...
    def test_any_python_expression_may_be_interpolated(self):
        ...
        string = "The square root of 5 is {0:.{1}f}".format(math.sqrt(5),
            decimal_places) # With 1 format input, both variables are used to create a float with the result and 4 decimal_places
    ...
    def test_single_characters_can_be_represented_by_integers(self):
        self.assertEqual(97, ord('a'))  # Casting string to integer gets it's ascii value
