...
class AboutDeletingObjects(Koan):
    ...
    def test_del_can_remove_attributes(self):
        ...
        self.assertRegex(err_msg1, "'ClosingSale' object has no attribute 'toilet_brushes'")  # shouldn't exist in the class
        self.assertRegex(err_msg2, "'ClosingSale' object has no attribute 'hamsters'")  # shouldn't exist in this instance of the class
    ...
    class ClintEastwood:
        ...
        def get_name(self):
            try:
                ...
                # raise(e) AttributeError: 'ClintEastwood' object has no attribute '_name'. Did you mean: 'name'
